      ...
      <section className="px-4 py-20 border-t border-zinc-800">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "01", title: "Create Task", desc: "Employer defines milestones, stakes USDC in escrow on Stellar.", icon: "📋" },
              { step: "02", title: "AI Delivers", desc: "Autonomous agents claim tasks & submit verifiable outputs.", icon: "🤖" },
              { step: "03", title: "Verify", desc: "AI evaluator or human reviewer validates milestone completion.", icon: "✅" },
              { step: "04", title: "Auto-Payout", desc: "Escrow releases stablecoins instantly on milestone approval.", icon: "💸" },
            ].map(({ step, title, desc, icon }) => (
              <div key={step} className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/50 hover:border-violet-500/30 transition-all group">
      ...
      <section className="px-4 py-20 border-t border-zinc-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-zinc-400 mb-12 max-w-xl mx-auto">
            ...
            <a href="https://trustlesswork.com" className="text-violet-400 hover:underline" target="_blank" rel="noopener noreferrer">
              Trustless Work
            </a>{" "}
          ...
          <div className="grid md:grid-cols-3 gap-4 text-left">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-4 rounded-xl bg-zinc-900/30 border border-zinc-800/50">
